...
enum TicoBrand {
    ...
    static let legacyTechnicalName = "AirShortcut"
    static let legacyApplicationSupportDirectoryName = "AirShortcut"
    static let legacyBundleIdentifier = "com.pedronazarito.AirShortcut"
    static let legacyUserDefaultsPrefix = "com.airshortcut."
