...
final class TicoBrandTests: XCTestCase {
    func testBrandIdentityKeepsPublicAndLegacyTechnicalNamesSeparate() {
        XCTAssertEqual(TicoBrand.displayName, "Tico")
        XCTAssertEqual(TicoBrand.legacyTechnicalName, "AirShortcut")
        XCTAssertEqual(TicoBrand.legacyApplicationSupportDirectoryName, "AirShortcut")
        XCTAssertEqual(TicoBrand.legacyBundleIdentifier, "com.pedronazarito.AirShortcut")
        XCTAssertEqual(TicoBrand.legacyUserDefaultsPrefix, "com.airshortcut.")
    }
