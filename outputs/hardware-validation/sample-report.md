...
| --- | --- | --- | --- | --- | --- | --- | --- |
| macOS 14.x | internal | advanced-private | Tap | One configured tap is recognized | One recognition was shown after one configured tap | PASS | Fictional example; only the summary is retained |
